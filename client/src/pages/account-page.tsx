    ...
    <div className="container mx-auto py-6 px-4 max-w-screen-xl">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          <TabsContent value="profile" className={activeTab === 'profile' ? 'block mt-0' : 'hidden'}>
          ...
          <TabsContent value="api" className={activeTab === 'api' ? 'block mt-0' : 'hidden'}>
            <Card className="bg-[#0F212E] border-[#243442] text-white">
              <CardHeader>
                <CardTitle className="text-xl flex items-center">
          ...
          <TabsContent value="payment" className={activeTab === 'payment' ? 'block mt-0' : 'hidden'}>
            <Card className="bg-[#0F212E] border-[#243442] text-white mb-6">
              <CardHeader>
                <CardTitle className="text-xl flex items-center">
          ...
          <TabsContent value="transactions" className={activeTab === 'transactions' ? 'block mt-0' : 'hidden'}>
            <Card className="bg-[#0F212E] border-[#243442] text-white">
              <CardHeader>
                <CardTitle className="text-xl flex items-center">
                  <History className="mr-2 h-5 w-5 text-[#1375e1]" />
