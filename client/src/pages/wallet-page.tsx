            ...
            <Card className="bg-[#172B3A] border-[#243442] text-white shadow-lg">
              ...
              <CardContent>
                <div className="flex items-center">
                  <span className="text-3xl font-bold font-mono">1.00000000</span>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between border-b border-[#243442] pb-3">
                  ...
                  <div className="text-right">
                    <p className="font-mono">0.50000000</p>
                ...
                <div className="flex items-center justify-between border-b border-[#243442] pb-3">
                  ...
                  <div className="text-right">
                    <p className="font-mono">1.25000000</p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-mono">1,250.00</p>
                  ...
                  <TabsContent value="withdraw">
                    <Form {...withdrawForm}>
                      <form onSubmit={withdrawForm.handleSubmit(handleWithdraw)} className="space-y-6">
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <div className="flex justify-between">
                                <FormMessage />
                                <p className="text-sm text-[#7F8990]">Available: 1.00000000</p>
                              </div>
                            </FormItem>
                          )}
                        />
                        ...
                        <div className="bg-[#0F212E] border border-[#243442] rounded-md p-4 text-sm">
                          <h4 className="font-medium mb-2">Withdrawal Information</h4>
                          <ul className="space-y-1 text-[#7F8990]">
                            <li>• Minimum withdrawal: 0.0005 BTC</li>
                            <li>• Fee: 0.0001 BTC</li>
                            <li>• Processing time: 10-30 minutes</li>
                            <li>• Daily limit: 2 BTC</li>
                          </ul>
                        </div>
                  ...
                  <TabsContent value="convert">
                    <div className="flex flex-col items-center justify-center py-12">
                      <div className="text-center mb-6">
                        <CircleDollarSign className="h-16 w-16 mx-auto mb-4 text-[#1375e1]" />
                        <h3 className="text-xl font-bold mb-2">Convert Crypto</h3>
                        <p className="text-[#7F8990]">
                          Instantly convert between different cryptocurrencies
                        </p>
                      </div>
                      ...
                      <Button 
                        ...
                        onClick={() => {
                          toast({
                            title: "Coming Soon",
                            description: "Crypto conversion will be available in the next update!",
                          });
                        }}
                      >
                        Coming Soon
