...
const DiceGame = () => {
  // Local state for bet amount instead of using context
  ...
  const renderControlsPanel = () => (
    <div className="h-full flex flex-col">
      ...
      <GameControls
        betAmount={formatCrypto(betAmount)}
        onBetAmountChange={(value) => setBetAmount(parseFloat(value) || 0)}
        onHalfBet={handleHalfBet}
        onDoubleBet={handleDoubleBet}
        onBet={handleBet}
        betButtonText={rolling ? 'Rolling...' : 'Bet'}
        betButtonDisabled={rolling || betAmount <= 0}
      >
        {/* Profit on Win */}
        <div className="mb-6">
  ...
  return (
    <GameLayout
      title="Dice"
      controlsPanel={renderControlsPanel()}
