      ...
      <div className="p-4 flex">
        ...
        <div className="w-1/2">
          <div 
            ...
            style={{ backgroundImage: `url(${imageSrc || 'https://res.cloudinary.com/dq8b1e8qy/image/upload/v1744994041/24d3cdf5c6555efee525cd6169c05262df312992-1080x1080_b45vlv.png'})` }}
          />
        </div>
      </div>
    </div>
